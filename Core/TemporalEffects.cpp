...
void TemporalEffects::ApplyTemporalAA(ComputeContext& Context)
{
    ...
    Context.SetDynamicSampler(0, SamplerLinearBorder);
    Context.SetDynamicSampler(1, SamplerPointBorder);
    ...
    Context.SetDynamicDescriptor(3, g_LinearDepth[Src].GetSRV());
    Context.SetDynamicDescriptor(4, g_LinearDepth[Dst].GetSRV());
