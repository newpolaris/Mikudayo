...
namespace
{
    const InputDesc VertElem[] = {
        ...
        { "TANGENTU", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D12_APPEND_ALIGNED_ELEMENT,  D3D11_INPUT_PER_VERTEX_DATA, 0 },
...
bool SkydomeModel::Load( const ModelInfo& info )
{
    ...
    m_Transform = AffineTransform::MakeScale(5000) * OrthogonalTransform(Quaternion(0, XM_PIDIV2, 0));
